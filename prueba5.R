...
png("aprox.png")
boxplot(ap,names= c("2^10", "2^12", "2^14", "2^16", "2^18", "2^20", "2^22"))
abline(h=0.0488341111) 
graphics.off()

png("tiempos.png")
boxplot(ti,names= c("2^10", "2^12", "2^14", "2^16", "2^18", "2^20", "2^22"))
graphics.off()

png("error.png")
boxplot(er,names= c("2^10", "2^12", "2^14", "2^16", "2^18", "2^20", "2^22"))
graphics.off()
